...
const nftpool_abi_1 = __importDefault(require("./nftpool-abi"));
const app_config_1 = require("../app.config");
const supportTokenList = [
    [
        ["0xba8cDaa1C4C294aD634ab3c6Ee0FA82D0A019727", "polkapets tcg"],
        ...
        ["0x401b3474a0a2fbCB00d516c1FFC01854b9D9dafe", "TBE"],
        ["0x0c69326bEA87398A12BE5d3224bd37Ac64b30b76", "Logan Paul Store"],
        ["0xDdaf2A168833de8c47C58C7F4E0F412146c1d0f9", "DeFi Now"],
...
class Contract {
    constructor(address, handler, network, appkey) {
        ...
        this.logger = new common_1.Logger('nftswap-contract');
        this.logCreateNFTPool = async (args, log) => {
            if (!args.listId)
                return;
            try {
                ...
                const list = app_config_1.IS_DEV ? supportTokenList[1] : supportTokenList[0];
                let name = '';
        ...
        this.logNFTSwapped = async (args, log) => {
            if (!args.listId)
                return;
            try {
                const poolId = args.listId.toString();
        ...
        this.abi = new ethers_1.ethers.utils.Interface(nftpool_abi_1.default);
        this.provider = new ethers_1.ethers.providers.InfuraProvider(network, appkey);
        this.contract = new ethers_1.ethers.Contract(address, nftpool_abi_1.default, this.provider);
...
//# sourceMappingURL=nftpool.contract.js.map